/*
 * from github FastMemcpy.c
 */

#ifndef __ZTL_FAST_MEMCPY_H__
#define __ZTL_FAST_MEMCPY_H__
...
//---------------------------------------------------------------------
    ...
    #define ZTL_INLINE     __inline__ __attribute__((always_inline))
#else
    #define ZTL_INLINE     __inline__
#endif
#elif defined(_MSC_VER)
	#define ZTL_INLINE __forceinline
#elif (defined(__BORLANDC__) || defined(__WATCOMC__))
    #define ZTL_INLINE __inline
#else
    #define ZTL_INLINE 
#endif
#endif
...
//---------------------------------------------------------------------
static ZTL_INLINE void memcpy_sse2_16(void *dst, const void *src) {
	__m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
	_mm_storeu_si128(((__m128i*)dst) + 0, m0);
}

static ZTL_INLINE void memcpy_sse2_32(void *dst, const void *src) {
	__m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
...
static ZTL_INLINE void memcpy_sse2_64(void *dst, const void *src) {
	__m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
	__m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
...
static ZTL_INLINE void memcpy_sse2_128(void *dst, const void *src) {
	__m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
	__m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
	__m128i m2 = _mm_loadu_si128(((const __m128i*)src) + 2);
	__m128i m3 = _mm_loadu_si128(((const __m128i*)src) + 3);
...
//---------------------------------------------------------------------
static ZTL_INLINE void *memcpy_tiny(void *dst, const void *src, size_t size) {
...
// main routine
//---------------------------------------------------------------------
static void* ztl_memcpy(void *destination, const void *source, size_t size)
{
